...
urlpatterns = [
    ...
    path('estadisticas/', views.asistencia_estadisticas, name='asistencia_estadisticas'),
    path('estadisticas/pdf/', views.asistencia_estadisticas_pdf, name='asistencia_estadisticas_pdf'),
