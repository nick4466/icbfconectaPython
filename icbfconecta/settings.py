"""
Django settings for icbfconecta project.
...
INSTALLED_APPS = [
    ...
    'core', 
   'planeaciones.apps.PlaneacionesConfig',
    'asistencia',
    'novedades',
    'desarrollo',
    'correos',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'icbfconecta.context_processors.user_context',  # Añadir el context processor personalizado
            ],
        },
    },
]

WSGI_APPLICATION = 'icbfconecta.wsgi.application'
...
STATIC_URL = '/static/'
# Usar rutas relativas en ambos entornos
...
MEDIA_URL = '/media/'
# Usar siempre ruta relativa - funciona en local y en PythonAnywhere
