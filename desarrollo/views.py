...
def eliminar_desarrollos_seleccionados(request):
    ...
    if count > 0:
        ...
        messages.error(request, f"Se han eliminado {count} registros de desarrollo exitosamente.")
...
def eliminar_seguimientos_lote(request):
    ...
    if not seguimiento_ids:
        ...
        try:
            ...
            messages.error(request, f'Se eliminaron {count} seguimientos exitosamente.')  # <-- Cambia success por error
        except Exception as e:
